...
public class ContextRunnerDecorator {
  ...
  public ContextRunnerDecorator withEnabled(boolean enabled) {
    this.contextRunner = this.contextRunner.withPropertyValues(
        OutboxProperties.EnvPropertyKeys.ENABLED.getKeyWithPrefix() + "=" + enabled);
    return this;
  }

  public ContextRunnerDecorator withFixedDelay(long fixedDelay) {
    this.contextRunner = this.contextRunner.withPropertyValues(
        OutboxProperties.EnvPropertyKeys.FIXED_DELAY.getKeyWithPrefix() + "=" + fixedDelay);
    return this;
  }
  ...
  public ContextRunnerDecorator withTransactionManager() {
    ...
    this.contextRunner =
        this.contextRunner.withBean("transactionManager", PlatformTransactionManager.class, () -> transactionManager);
    return this;
  }
